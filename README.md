...
**Phase 2 of 7.** Architecture defined, workspace and tooling in place.
...
| 3 | Prisma schema, migrations, row-level security | ▶ next |
...
Requires Node 22+, pnpm 10+, and Docker (or a reachable Postgres 16 with pgvector and Redis).
