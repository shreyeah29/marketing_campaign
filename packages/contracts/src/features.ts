...
const marketing: readonly FeatureManifest[] = [
  ...
  f({
    ...
    name: 'Instagram',
    description: 'The Instagram channel hub — posts, scheduling and per-post results.',
    category: 'Marketing',
    version: 1,
    dependencies: ['marketing.social'],
    defaultEnabled: true,
    billingCategory: 'included',
    navEntry: {
      label: 'Instagram',
    ...
    apiRoutes: ['/v1/social'],
    frontendRoutes: ['/marketing/instagram'],
    backendModule: 'social',
  }),
  f({
    id: 'marketing.facebook',
    name: 'Facebook',
    description: 'The Facebook channel hub — posts, scheduling and per-post results.',
    category: 'Marketing',
    version: 1,
    dependencies: ['marketing.social'],
    defaultEnabled: true,
    ...
    requiredPermissions: ['social:publish'],
    apiRoutes: ['/v1/social'],
    frontendRoutes: ['/marketing/facebook'],
    backendModule: 'social',
  }),
  f({
    id: 'marketing.seo',
...
const analytics: readonly FeatureManifest[] = [
  ...
  f({
    ...
    description: 'Ad reach, audience demographics, geography and leads.',
    category: 'Analytics',
    version: 1,
    dependencies: ['analytics.dashboard'],
    defaultEnabled: true,
    ...
    requiredPermissions: ['analytics:read'],
    apiRoutes: ['/v1/meta/analytics'],
    frontendRoutes: ['/analytics/campaigns'],
    backendModule: 'meta',
  }),
  f({
    id: 'analytics.kpi',
  ...
  f({
    ...
    description: 'Month view of everything scheduled and published across platforms.',
    category: 'Analytics',
    version: 1,
    dependencies: ['analytics.dashboard'],
    defaultEnabled: true,
    ...
    requiredPermissions: ['analytics:read'],
    apiRoutes: ['/v1/campaign-assets'],
    frontendRoutes: ['/analytics/calendar'],
    backendModule: 'marketing',
  }),
  f({
    id: 'analytics.leads',
    name: 'Lead Analytics',
    description: 'Lead funnel, per-source performance and trend.',
    category: 'Analytics',
    version: 1,
    dependencies: ['analytics.dashboard', 'crm.leads'],
    defaultEnabled: true,
    billingCategory: 'included',
    navEntry: {
    ...
    requiredPermissions: ['analytics:read'],
    apiRoutes: ['/v1/analytics/leads'],
    frontendRoutes: ['/analytics/leads'],
    backendModule: 'analytics',
  }),
  f({
