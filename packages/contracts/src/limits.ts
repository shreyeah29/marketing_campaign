...
export const LIMITS: readonly LimitDefinition[] = [
  ...
  l({
    id: 'ai_requests',
    name: 'AI Requests',
    description: 'Model calls per month.',
    unit: 'count',
    period: 'monthly',
    meter: 'counter',
    feature: null,
  ...
  l({
    id: 'voice_minutes',
    name: 'Voice Minutes',
    description: 'AI call minutes per month.',
    unit: 'minutes',
    period: 'monthly',
    meter: 'counter',
    feature: 'ai.voice_calling',
  }),
  l({
    id: 'emails',
    name: 'Emails',
  ...
  l({
    id: 'sms',
    name: 'SMS',
    description: 'SMS sent per month.',
    unit: 'count',
    period: 'monthly',
    meter: 'counter',
  ...
  l({
    id: 'knowledge_base_mb',
    name: 'Knowledge Base Size',
    description: 'Indexed knowledge, in MB.',
    unit: 'megabytes',
    period: 'total',
    meter: 'gauge',
    feature: 'ai.knowledge_base',
  }),
  l({
    id: 'api_requests',
    name: 'API Requests',
