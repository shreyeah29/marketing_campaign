...
export default function ReceptionistPage() {
  return (
    <ModuleIntro
      ...
      subtitle="An always-on voice agent that answers and routes calls"
      icon="phone"
      requires="Connect a telephony provider (Twilio / Vapi / Retell) and a voice provider to take calls."
      capabilities={[
