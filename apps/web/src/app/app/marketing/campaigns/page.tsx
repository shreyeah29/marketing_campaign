...
// ── Template library — winning campaign structures, reused in one click ───────
...
const TEMPLATE_CATEGORY = 'Campaign template'
...
function SaveTemplateButton({ campaign }: { campaign: Campaign }) {
  const toast = useToast()
  const [busy, setBusy] = useState(false)
